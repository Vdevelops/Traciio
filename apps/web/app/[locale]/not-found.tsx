...
/**
 * Not Found page untuk routes di dalam locale
 * Verifies auth via API before showing appropriate navigation options
 */
    ...
    <main className="flex min-h-screen items-center justify-center bg-sidebar px-4">
      <div className="flex flex-col items-center text-center space-y-4">
        <div className="relative">
          <span className="text-8xl sm:text-9xl font-medium text-primary/20 select-none">
            404
          </span>
        </div>
