...
export function IndustryForm({ initialData, onSubmit, isSubmitting, onCancel }: IndustryFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Textarea
          id="description"
          placeholder="Description of this industry"
      ...
      <div className="flex items-center space-x-3 rounded-md border p-4">
        ...
        <div className="space-y-1 leading-none">
          ...
          <p className="text-xs text-muted-foreground">
            Active industries are available for selection in lead forms
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 pt-4">
        ...
        <Button type="submit" disabled={isSubmitting} className="cursor-pointer w-full sm:w-auto">
          {isSubmitting ? "Saving..." : initialData ? "Update Industry" : "Create Industry"}
        </Button>
      </div>
    </form>
  );
