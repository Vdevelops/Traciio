...
export function LeadSourceList(): React.JSX.Element {
  ...
  const handleCreate = async (data: CreateLeadSourceRequest | UpdateLeadSourceRequest) => {
    await createMutation.mutateAsync(data as CreateLeadSourceRequest);
    setIsCreateDialogOpen(false);
  };

  const handleUpdate = async (data: CreateLeadSourceRequest | UpdateLeadSourceRequest) => {
