...
import type { User, ListUsersResponse, UserResponse, ListRolesResponse, Role, MobilePermissionsResponse, ListPermissionsResponse, Permission, UserPermissionsApiResponse, Menu } from "../types";
...
export const menuService = {
  async list(): Promise<{ success: boolean; data: Menu[]; timestamp: string; request_id: string }> {
    const response = await apiClient.get<{ success: boolean; data: Menu[]; timestamp: string; request_id: string }>("/menus");
    return response.data;
  },
