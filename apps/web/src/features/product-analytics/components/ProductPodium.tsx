...
interface ProductPodiumProps {
  readonly topThree: readonly ProductListItem[];
}
...
export function ProductPodium({ topThree }: ProductPodiumProps) {
  const t = useTranslations("productAnalytics.podium");
  ...
  return (
    <div className="relative mb-8">
      ...
      <div className="relative flex items-end justify-center gap-6 pt-8 pb-4">
        ...
        <div className="flex flex-col items-center z-10">
          <div className="relative mb-3">
            <ProductImage
              ...
              alt={second?.product_name ?? t("second")}
              size="lg"
              className="h-20 w-20 border-2 border-secondary/40 dark:border-secondary/30 shadow-lg ring-1 ring-secondary/20 dark:ring-secondary/10"
              fallbackClassName="bg-gradient-to-br from-secondary/20 to-secondary/40 dark:from-secondary/30 dark:to-secondary/50"
              loading="eager"
            />
          ...
          <div className="relative bg-gradient-to-b from-secondary/10 to-secondary/30 dark:from-secondary/20 dark:to-secondary/40 rounded-t-xl px-6 py-8 min-w-[140px] text-center border border-secondary/30 dark:border-secondary/40 shadow-lg">
            ...
            <div className="relative">
              ...
              <div className="font-medium text-sm mb-1 text-secondary-foreground dark:text-secondary-foreground truncate">
                {second?.product_name ?? "-"}
              </div>
              {second && (
                <>
                  ...
                  <div className="text-xs text-secondary-foreground/70 dark:text-secondary-foreground/80 font-medium">
                    {formatNumber(second.total_sold)} {t("sold")}
                  </div>
        ...
        {/* 1st Place - Using Primary (Orange) */}
        <div className="flex flex-col items-center z-20">
          <div className="relative mb-3">
            <ProductImage
              src={first?.image_url}
              alt={first?.product_name ?? t("first")}
              className="h-28 w-28 border-2 border-primary/50 dark:border-primary/40 shadow-xl ring-2 ring-primary/20 dark:ring-primary/10"
              fallbackClassName="bg-gradient-to-br from-primary/20 to-primary/40 dark:from-primary/30 dark:to-primary/50"
              loading="eager"
            />
          ...
          <div className="relative bg-gradient-to-b from-primary/10 via-primary/20 to-primary/30 dark:from-primary/20 dark:via-primary/30 dark:to-primary/40 rounded-t-xl px-6 py-12 min-w-[160px] text-center border border-primary/30 dark:border-primary/40 shadow-xl">
            ...
            <div className="relative">
              ...
              <div className="font-medium text-base mb-2 text-primary dark:text-primary truncate">
                {first?.product_name ?? "-"}
              </div>
              {first && (
                <>
                  ...
                  <div className="text-xs text-primary/80 dark:text-primary/90 font-medium">
                    {formatNumber(first.total_sold)} {t("sold")}
                  </div>
        ...
        <div className="flex flex-col items-center z-10">
          <div className="relative mb-3">
            <ProductImage
              src={third?.image_url}
              alt={third?.product_name ?? t("third")}
              size="sm"
              className="h-16 w-16 border-2 border-muted-foreground/20 dark:border-muted-foreground/30 shadow-lg ring-1 ring-muted-foreground/10 dark:ring-muted-foreground/10"
              fallbackClassName="bg-gradient-to-br from-muted to-muted-foreground/10 dark:from-muted dark:to-muted-foreground/20"
              loading="eager"
            />
          ...
          <div className="relative bg-gradient-to-b from-muted to-muted-foreground/10 dark:from-muted dark:to-muted-foreground/20 rounded-t-xl px-4 py-6 min-w-[120px] text-center border border-muted-foreground/20 dark:border-muted-foreground/30 shadow-lg">
            ...
            <div className="relative">
              ...
              <div className="font-medium text-xs mb-1 text-muted-foreground dark:text-muted-foreground truncate">
                {third?.product_name ?? "-"}
              </div>
              {third && (
                <>
                  ...
                  <div className="text-xs text-muted-foreground/70 dark:text-muted-foreground/80 font-medium">
                    {formatNumber(third.total_sold)} {t("sold")}
                  </div>
