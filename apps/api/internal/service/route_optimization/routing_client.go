...
type RouteRequest struct {
	...
	Profile      string      // driving, walking, cycling (default: driving)
	Overview     string      // simplified, full, false (default: full)
	Geometries   string      // polyline, geojson (default: polyline)
	Steps        bool        // Include step-by-step instructions (default: true)
	Alternatives bool        // Return alternative routes (default: false)
}
