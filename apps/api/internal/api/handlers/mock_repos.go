...
func (m *MockRefreshTokenRepository) Create(token *refresh_token.RefreshToken) error {
	if m.CreateFunc != nil { return m.CreateFunc(token) }
	return nil
}
func (m *MockRefreshTokenRepository) FindByTokenID(tokenID string) (*refresh_token.RefreshToken, error) { return nil, nil }
func (m *MockRefreshTokenRepository) FindByUserID(userID string) ([]*refresh_token.RefreshToken, error) { return nil, nil }
...
func (m *MockUserRepository) Update(user *user.User) error {
	if m.UpdateFunc != nil { return m.UpdateFunc(user) }
	return nil
}
...
func (m *MockRoleRepository) AssignPermissions(roleID string, permissionIDs []string) error { return nil }
...
func (m *MockGroupRepository) Create(group *group.Group) error {
	if m.CreateFunc != nil { return m.CreateFunc(group) }
	return nil
}
func (m *MockGroupRepository) Update(group *group.Group) error {
	if m.UpdateFunc != nil { return m.UpdateFunc(group) }
	return nil
}
...
func (m *MockGroupRepository) CountUsersByGroupID(groupID string) (int64, error) {
	if m.CountUsersByGroupIDFunc != nil { return m.CountUsersByGroupIDFunc(groupID) }
	return 0, nil
}
...
func (m *MockMonthlyTargetRepository) GetUserEffectiveTarget(userID string, year, month int) (*monthly_target.MonthlyTarget, error) { return nil, nil }
func (m *MockMonthlyTargetRepository) BatchGetUserEffectiveTargets(userIDs []string, year, month int) (map[string]*monthly_target.MonthlyTarget, error) {
	if m.BatchGetUserEffectiveTargetsFunc != nil { return m.BatchGetUserEffectiveTargetsFunc(userIDs, year, month) }
	return nil, nil
}
...
func (m *MockMonthlyTargetRepository) FindByUserAndPeriod(userID string, year, month int) (*monthly_target.MonthlyTarget, error) { return nil, nil }
func (m *MockMonthlyTargetRepository) FindByGroupAndPeriod(groupID string, year, month int) (*monthly_target.MonthlyTarget, error) { return nil, nil }
func (m *MockMonthlyTargetRepository) FindByBrickAndPeriod(brickID string, year, month int) (*monthly_target.MonthlyTarget, error) { return nil, nil }
...
func (m *MockAccountRepository) Create(account *account.Account) error {
	if m.CreateFunc != nil { return m.CreateFunc(account) }
	return nil
}
...
func (m *MockMenuRepository) FindByURL(url string) (*permission.Menu, error) {
	if m.FindByURLFunc != nil { return m.FindByURLFunc(url) }
	return nil, nil
}
...
func (m *MockMenuRepository) GetRootMenus() ([]permission.Menu, error) {
	if m.GetRootMenusFunc != nil { return m.GetRootMenusFunc() }
	return nil, nil
}
func (m *MockMenuRepository) Create(menu *permission.Menu) error {
	if m.CreateFunc != nil { return m.CreateFunc(menu) }
	return nil
}
func (m *MockMenuRepository) Update(menu *permission.Menu) error {
	if m.UpdateFunc != nil { return m.UpdateFunc(menu) }
	return nil
}
...
func (m *MockProductRepository) Create(product *product.Product) error {
	if m.CreateFunc != nil { return m.CreateFunc(product) }
	return nil
}
func (m *MockProductRepository) Update(product *product.Product) error {
	if m.UpdateFunc != nil { return m.UpdateFunc(product) }
	return nil
}
...
func (m *MockContactRoleRepository) Create(cr *contact_role.ContactRole) error {
	if m.CreateFunc != nil { return m.CreateFunc(cr) }
	return nil
}
func (m *MockContactRoleRepository) Update(cr *contact_role.ContactRole) error {
	if m.UpdateFunc != nil { return m.UpdateFunc(cr) }
	return nil
}
...
func (m *MockLeadRepository) Create(l *lead.Lead) error {
	if m.CreateFunc != nil { return m.CreateFunc(l) }
	return nil
}
func (m *MockLeadRepository) Update(l *lead.Lead) error {
	if m.UpdateFunc != nil { return m.UpdateFunc(l) }
	return nil
}
...
func (m *MockLeadRepository) CountByDateRange(startDate, endDate interface{}) (int64, error) { 
	if m.CountByDateRangeFunc != nil { return m.CountByDateRangeFunc(startDate, endDate) }
	return 0, nil 
}
...
func (m *MockLeadRepository) GetStatsBySourceAndDateRange(startDate, endDate interface{}) (map[string]int64, error) {
	if m.GetStatsBySourceAndDateRangeFunc != nil { return m.GetStatsBySourceAndDateRangeFunc(startDate, endDate) }
	return nil, nil
}
...
func (m *MockDealRepository) Create(d *pipeline.Deal) error {
	if m.CreateFunc != nil { return m.CreateFunc(d) }
	return nil
}
...
func (m *MockDealRepository) GetSummaryInPeriod(startDate, endDate interface{}) (*pipeline.PipelineSummaryResponse, error) {
	if m.GetSummaryInPeriodFunc != nil { return m.GetSummaryInPeriodFunc(startDate, endDate) }
	return nil, nil
}
...
func (m *MockPipelineRepository) FindStageByID(id string) (*pipeline.PipelineStage, error) {
	if m.FindStageByIDFunc != nil { return m.FindStageByIDFunc(id) }
	return nil, nil
}
func (m *MockPipelineRepository) GetFirstStage() (*pipeline.PipelineStage, error) {
	if m.GetFirstStageFunc != nil { return m.GetFirstStageFunc() }
	return nil, nil
}
...
func (m *MockPipelineRepository) ListStages(req *pipeline.ListPipelineStagesRequest) ([]pipeline.PipelineStage, error) { return nil, nil }
func (m *MockPipelineRepository) ReorderStages(orders map[string]int) error { return nil }
func (m *MockPipelineRepository) FindStageByCode(code string) (*pipeline.PipelineStage, error) { return nil, nil }
...
func (m *MockContactRepository) Create(c *contact.Contact) error {
	if m.CreateFunc != nil { return m.CreateFunc(c) }
	return nil
}
...
func (m *MockContactRepository) ListByAccountID(accountID string) ([]contact.Contact, error) { return nil, nil }
...
func (m *MockLeadStatusRepository) FindDefault() (*lead_status.LeadStatus, error) {
	if m.FindDefaultFunc != nil { return m.FindDefaultFunc() }
	return nil, nil
}
...
func (m *MockDealHistoryRepository) ListByDealID(dealID string) ([]deal_history.DealHistory, error) { return nil, nil }
func (m *MockDealHistoryRepository) Delete(id string) error { return nil }
func (m *MockDealHistoryRepository) FindByDealID(dealID string) ([]deal_history.DealHistory, error) { return nil, nil }
func (m *MockDealHistoryRepository) FindByID(id string) (*deal_history.DealHistory, error) { return nil, nil }
func (m *MockDealHistoryRepository) List(dealID string, limit int) ([]deal_history.DealHistory, error) { return nil, nil }
...
func (m *MockActivityRepository) GetStats(start, end, userID string) (map[string]int64, error) { return nil, nil }
func (m *MockActivityRepository) CountActivities(userID string, start, end time.Time) (int64, error) { return 0, nil }
func (m *MockActivityRepository) FindByAccountID(accountID string) ([]activity.Activity, error) { return nil, nil }
func (m *MockActivityRepository) GetStatsByType(startDate, endDate string, accountID string) (map[string]int64, error) { return nil, nil }
func (m *MockActivityRepository) GetStatsByTypeAndDate(startDate, endDate string, accountID string) (map[string]map[string]int64, error) { return nil, nil }
func (m *MockActivityRepository) GetStatsByUser(startDate, endDate string, accountID string) (map[string]int64, error) { return nil, nil }
...
func (m *MockVisitReportRepository) FindByID(id string) (*visit_report.VisitReport, error) { return nil, nil }
func (m *MockVisitReportRepository) List(req *visit_report.ListVisitReportsRequest) ([]visit_report.VisitReport, int64, error) { return nil, 0, nil }
...
func (m *MockVisitReportRepository) GetStatsByBrick(start, end, userID string) (map[string]int64, error) { return nil, nil }
...
func (m *MockVisitReportRepository) CountVisits(userID string, start, end time.Time) (int64, error) { return 0, nil }
...
func (m *MockTaskRepository) CountTasks(userID string, start, end time.Time) (int64, error) { return 0, nil }
